        ...
        <div class="element-wrapper">
            ...
            <div class="row">
                <div class="tab-content">
                    <div class="col-lg-8">
                        <?= $form->field($model, 'profile_pic')->fileInput(['required'=>true])->label('Browse Passport Photo') ?> 
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <?= $form->field($model, 'identfication_number')->hiddenInput()->label(false); ?>
                        ...
                        <?= $form->field($model, 'physical_address')->hiddenInput()->label(false); ?>
