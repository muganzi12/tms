                ...
                <div class="bg-dark" style="min-height: 40px;  background: linear-gradient(to right, #8dbef2, #77c6ed) !important;">
                    <div class="d-flex align-items-end container-fluid page__container" style="position: absolute; left: 0; right: 0; bottom: 0;">
                        ...
                        <div class="card-header card-header-tabs-basic nav flex" role="tablist">
                            <?= Html::a('<i class="material-icons mr-1">description</i> Loan', ['loan/view', 'id' => $loan_id], ['class' => 'active']); ?>
                            ...
                            <?= Html::a('<i class="material-icons mr-1">payment</i>Payment History', ['loan/loan-payment-history', 'id' => $loan_id], ['class' => '']); ?>
                             <?= Html::a('<i class="material-icons mr-1">payment</i>Penalties', ['loan/loan-payment-penalties', 'id' => $loan_id], ['class' => '']); ?>
                            ...
                            <?= Html::a('<i class="material-icons mr-1">payment</i> Proof of Payment', ['loan/proof-of-payments', 'id' => $loan_id], ['class' => '']); ?> 
                            <?= Html::a('<i class="material-icons mr-1">list</i>Loan Profile', ['loan/view-loan-profile', 'id' => $loan_id], ['class' => 'pull-right']); ?>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container-fluid page__container">
                <div class="row">
                    ...
                    <div class="col-lg-3" style="border-left:0px solid #eee;">
                        ...
                        <p class="text-muted"><b>File Number:</b> <?= @$loan->client->external_id; ?></p>
                        ...
                        <ul class="list-group" style="margin-top:20px;margin-bottom:20px;">   
                            ...
                            <?php if (@$loan->status == 41) { ?>
                                <li class="list-group-item"><b>
                                        <?= Html::a('<i class="material-icons">done_all</i> Offset Loan', ['loan/merge-loan', 'id' => $loan_id], ['class' => '']); ?>
                                    </b></li>
                            ...
                            <li class="list-group-item"><b>
                                    <?= Html::a('<i class="material-icons"></i> Make Payment', ['loan/make-loan-payment', 'id' => $loan_id], ['class' => '']); ?>
                                </b></li>
