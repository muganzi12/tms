    ...
    <div class="mdk-header__content">
        ...
        <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-dark  pr-0"
            ...
            <div class="container-fluid p-0">
                ...
                <a>
            <img src="<?=Yii::getAlias('@web/html');?>/images/demos.png" style="height: 70px;margin-left:20px;"/>

        </a>

                <!-- Navbar Brand -->
                <a href="<?=Url::base(true);?>" class="navbar-brand ">
                         <h4> <span>Tenant Management System</span></h4>
                </a>
                        ...
                        <a href="#account_menu"
                           ...
                           data-caret="false">
                            <span class="mr-1 d-flex-inline">
                                <span class="text-light"><?=Yii::$app->member->fullnames;?></span>
                            </span>
