...
<div class="payment-form">
    ...
    <div class="col-sm-6">
    <?=$form->field($property, 'property')->textInput(['readonly' => true])?>

    </div>

    <div class="col-sm-6">
    <?=$form->field($property, 'unit_number')->textInput(['readonly' => true])?>
   ...
   <div class="col-sm-6">
                    <?=$form->field($property, 'floor')->textInput(['readonly' => true])?>
        </div>
    <div class="col-sm-6">
    <?=$form->field($property, 'number_of_rooms')->textInput(['readonly' => true])?>

    </div>

        <div class="col-sm-6">
                    <?=$form->field($property, 'rate')->textInput(['readonly' => true])?>
        </div>
   </div>
    <div class="row">
...
<div class="col-sm-6">
                ...
                <?=$form->field($model, 'property_unit')->hiddenInput()->label(false)?>
