...
<div class="loan-product-form">
    ...
    <table class="table">
        <tr>
            ...
            <td>
                <?= $form->field($model, 'interest_rate')->textInput(['maxlength' => true, 'type' => 'number', 'step' => '0.01']) ?>
            </td>
            <td>  
                <?= $form->field($model, 'maximum_repayment_period')->textInput(['maxlength' => true, 'type' => 'number', 'step' => '1']) ?>

            </td>
            <td> <?= $form->field($model, 'processing_loan_fees')->textInput(['maxlength' => true]) ?>
            </td>
        </tr>
        <tr>

            <td>    <?= $form->field($model, 'minimum_amount')->textInput(['maxlength' => true]) ?>
            </td>
            <td>   <?= $form->field($model, 'maximum_amount')->textInput(['maxlength' => true]) ?>
            </td>
            <td>    <?= $form->field($model, 'principal_installment_frequency')->textInput(['maxlength' => true]) ?>
            </td>

            <td colspan="4">  <?= $form->field($model, 'interest_frequency')->textInput(['maxlength' => true]) ?>
            </td>
