...
class MemberController extends Controller {
     ...
     * Register a new Member
     */
    public function actionNewNextOfKin($kin) {
        $model = new NextOfKin();
        $member = $this->findModel($kin);
        $api = new ApiRequestHelper('sacco');
        if ($model->load(Yii::$app->request->post())) {
