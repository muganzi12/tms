...
class LeftNavigationDirector extends Nav {
    ...
    public static function getNavItems() {
        return [
            ...
            "<div class='sidebar-heading' style='margin-top:20px;color:#0d0d0d;'>Loans Checker</div> <hr>",
               ...
               [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">inbox</i> <span style="color:#0d0d0d;">Received Applications</span>',
