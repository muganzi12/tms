...
class LeftNavigation extends Nav {
    ...
    public static function getNavItems() {
        return [
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">account_circle</i> <span style="color:#0d0d0d">Dashboard</span>',
                'url' => ['site/index'],
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">assignment_ind</i> <span style="color:#0d0d0d;">Clients</span>',
                'url' => ['client/index'],
                'linkOptions' => ['class' => 'sidebar-menu-button'],
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">event_seat</i> <span style="color:#0d0d0d;">Investors</span> ',
                'url' => ['investor/index'],
                'linkOptions' => ['class' => 'sidebar-menu-button'],
                //'visible' => Yii::$app->user->can('Administrator'),
                'encode' => false,
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">check_box</i> <span style="color:#0d0d0d;">Pending applications</span>',
                'url' => ['loan/pending-loan-applications'],
                'linkOptions' => ['class' => 'sidebar-menu-button'],
                'visible' => Yii::$app->user->can('Loan Officer'),
                'encode' => false
            ],
            
                    [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">check_box</i> <span style="color:#0d0d0d;">Submitted to Manager</span>',
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">check_box</i> <span style="color:#0d0d0d;">Submitted to Director</span>',
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">done</i> <span style="color:#0d0d0d;">Approved loans</span>',
            ...
            [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">done_all</i> <span style="color:#0d0d0d;">Disbursed loans</span>',
                ...
                'encode' => false
                           ...
                           [
                'label' => '<i class="sidebar-menu-icon sidebar-menu-icon--left material-icons" style="color:#0d0d0d;">done_all</i> <span style="color:#0d0d0d;">Fully paid loans</span>',
            ...
            "<li class='sidebar-menu-item'>
                <a class='sidebar-menu-button'  data-toggle='collapse' href='#loan_principal'>
                    <i class='sidebar-menu-icon sidebar-menu-icon--left material-icons' style='color:#0d0d0d;'>payment</i>
