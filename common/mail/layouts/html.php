        ...
        <table class="row footer" style="width:80%; margin:0 auto;">
            <tr>        
                <td style="color:#068;text-align:center;">                
                    <p style='color:#999;font-size:13px;'>This email was automatically sent by <a href="https://sacco.kumusoft.com">Kumusoft Solutions</a></b>. Please do not reply</p>
                    <p style='font-size: 12px;'>Kumusoft Solutions . <br/>We are located at Plot 28, Martyrs Way, Ntinda ,Kampala, Uganda.
                    </p>
                </td>
            </tr>
        </table>
