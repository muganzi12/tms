...
/**
 * OverduePaymentsSearch represents the model behind the search form of `common\models\report\OverduePayments`.
 */
class OverduePaymentsSearch extends OverduePayments
{
    ...
    public function rules()
    {
        return [
            ...
            [['description', 'due_date', 'entry_type', 'stage', 'member_account', 'cancel_interest_reason'], 'safe'],
            [['amount'], 'number'],
        ];
    }
