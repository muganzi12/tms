...
/**
 * This is the model class for table "due_this_date".
 *
 * @property int $id
 ...
 */
class DueThisDate extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'entry_reference', 'debit_account', 'credit_account', 'entry_reference_id', 'created_at', 'created_by', 'entry_period', 'updated_at', 'updated_by', 'ledger_status', 'payment_ref', 'interest_status'], 'integer'],
