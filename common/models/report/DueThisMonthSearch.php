...
use common\models\report\DueThisMonth;

/**
 * DueThisMonthSearch represents the model behind the search form of `common\models\report\DueThisMonth`.
 */
class DueThisMonthSearch extends DueThisMonth
{
    /**
     * {@inheritdoc}
     */
