...
use common\models\report\DueThisDate;

/**
 * DueThisDateSearch represents the model behind the search form of `common\models\report\DueThisDate`.
 */
class DueThisDateSearch extends DueThisDate
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['description', 'due_date', 'entry_type', 'member_account','stage'], 'safe'],
            [['amount'], 'number'],
        ];
    }
